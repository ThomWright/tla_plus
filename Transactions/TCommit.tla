...
Terminate == /\ \E ts \in {"committed", "aborted"} :
                  \A r \in RM : rmState[r] = ts
             /\ rmState' = rmState
  (***********************************************************************)
  (* All RMs have arrived at the same decision, either "committed" or    *)
  (* "aborted".  The Terminate action leaves the state unchanged.        *)
  (***********************************************************************)
